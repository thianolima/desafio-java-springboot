package br.com.desafiojavaspringboot.configurations;
...
public class SwaggerConfiguration{
    ...
    public Docket apiDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("br.com.desafiojavaspringboot.controllers"))
                    .build()
                .apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Desafio Java SrpgingBoot - UOL")
